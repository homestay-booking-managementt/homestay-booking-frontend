  ...
  if (!isAuthenticated) {
    return (
      <div style={styles.container}>
        ...
        <p>
          Use credentials: <strong>2dawng / 1234</strong>
        </p>
      </div>
    );
  }
    ...
    <div style={styles.container}>
      ...
      <section style={styles.section}>
        ...
        <div style={styles.infoBox}>
          ...
          <p>
            <strong>Role ID:</strong> {currentUser.roleId}
          </p>
          <p>
            <strong>Is Admin:</strong> {currentUser.isAdmin ? "✅ Yes" : "❌ No"}
          </p>
          <p>
            <strong>Is Active:</strong> {currentUser.isActive ? "✅ Yes" : "❌ No"}
          </p>
        </div>
      </section>
      ...
      <section style={styles.section}>
        ...
        <Permission
          ...
          fallback={<div style={styles.warningBox}>⚠️ You don't have ADMIN permission</div>}
        >
          <div style={styles.successBox}>✅ You have ADMIN permission - Admin content visible!</div>
        </Permission>

        <h3>Example 3: Multiple Permissions (OR Logic)</h3>
        <Permission featureKey={[FeatureKey.BLOG_EDIT, FeatureKey.ADMIN]}>
          <div style={styles.successBox}>✅ You have either BLOG_EDIT or ADMIN permission</div>
        </Permission>
        ...
        <div style={styles.infoBox}>
          ...
          <Permission featureKey={FeatureKey.BLOG_EDIT} ownerId={1}>
            <div style={styles.successBox}>✅ You can edit this post (you are the owner)</div>
          </Permission>
          ...
          >
            <div style={styles.successBox}>✅ You can edit this post</div>
          </Permission>
        </div>
      </section>
      ...
      <section style={styles.section}>
        ...
        <details>
          ...
          <pre style={styles.code}>{JSON.stringify(permissions, null, 2)}</pre>
        </details>
      </section>
    </div>
  );
