...
export const OwnershipExample = ({ post }: { post: { id: number; title: string; authorId: number } }) => {
    return (
        <div className="blog-post">
            ...
            <Permission
                featureKey={FeatureKey.BLOG_DELETE}
                ownerId={post.authorId}
            >
...
export const MultiplePermissionsExample = ({ post }: { post: { id: number; authorId: number } }) => {
    return (
        <div>
            {/* Show if user has EITHER blog edit permission OR admin permission */}
            <Permission
                featureKey={[FeatureKey.BLOG_EDIT, FeatureKey.ADMIN]}
                ownerId={post.authorId}
            >
            ...
            <Permission
                featureKey={[FeatureKey.BLOG_DELETE, FeatureKey.ADMIN]}
                ownerId={post.authorId}
            >
                <button>Delete Post</button>
            </Permission>
...
export const TableExample = ({ items }: { items: Array<{ id: number; name: string; ownerId: number }> }) => {
    return (
            ...
            <tbody>
                {items.map((item) => (
                    <tr key={item.id}>
                        ...
                        <td>
                            <Permission
                                featureKey={FeatureKey.CONTENT_EDIT}
                            ...
                            <Permission
                                featureKey={FeatureKey.CONTENT_DELETE}
                                ownerId={item.ownerId}
                            >
...
export const HomestayExample = ({ homestay }: { homestay: { id: number; name: string; hostId: number } }) => {
    const { hasPermission: canEdit, checkOwner } = usePermission(FeatureKey.HOMESTAY_EDIT, homestay.hostId);
    ...
    return (
        <div className="homestay-card">
            ...
            <div className="actions">
                ...
                <Permission
                    featureKey={FeatureKey.HOMESTAY_EDIT}
                    ownerId={homestay.hostId}
                >
                ...
                <Permission
                    featureKey={FeatureKey.HOMESTAY_DELETE}
                    ownerId={homestay.hostId}
                >
    ...
    return (
        <div className="booking-card">
            ...
            <div className="actions">
                ...
                <Permission
                    featureKey={FeatureKey.BOOKING_CANCEL}
                    ownerId={booking.guestId}
                >
