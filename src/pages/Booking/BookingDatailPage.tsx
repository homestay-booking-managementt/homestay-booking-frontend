...
//       setLoading(true);
//       try {
//         const all = await fetchBookings(); // lấy toàn bộ mock data
//         // const data = Array.isArray(all) ? all : all.items ?? [];
//         const data = [
//   {
//     "id": 3,
//     "user_id": 2,
...
//       <Link to="/bookings" className="btn btn-light mb-3">
//         ← Quay lại danh sách
//       </Link>

//       <div className="card shadow-sm">
//         <div className="card-body">
//           <h4 className="mb-3">{booking.homestay.name}</h4>
...
//             <li><strong>Ngày đặt:</strong> {booking.created_at}</li>
//           </ul>
...
//             <li><strong>SĐT:</strong> {booking.user.phone}</li>
//           </ul>

//           <h5>Thông tin homestay</h5>
//           <ul className="list-unstyled">
//             <li><strong>Mô tả:</strong> {booking.homestay.description}</li>
//             <li><strong>Sức chứa:</strong> {booking.homestay.capacity} người</li>
//             <li><strong>Phòng tắm:</strong> {booking.homestay.bathroom_count}</li>
//             <li>
//               <strong>Tiện nghi:</strong>{" "}
//               {booking.homestay.amenities?.join(", ")}
//             </li>
//           </ul>
//         </div>
//       </div>
